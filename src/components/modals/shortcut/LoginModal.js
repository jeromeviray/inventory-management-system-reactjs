        ...
        if (username.length !== 0 && password.length !== 0) {
            this.props.authenticateUser(username, password)
                .then(() => {
                    ...
                    if (roles.roleName === Roles.SUPER_ADMIN || roles.roleName === Roles.ADMIN) {
        ...
        return (
            <>
                ...
                <CModal alignment="center" visible={visible} >
                    <CModalHeader onDismiss={() => this.props.setLoginModal(false, "loginclose")}>
...
export default connect(mapStateToProps, {
    setLoginModal, authenticateUser
})(LoginModal)
