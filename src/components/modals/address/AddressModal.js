        ...
        return (
            <>
                ...
                <CModal size="lg" visible={visible}>
                    <CModalHeader onDismiss={() => this.props.setAddressModal(false, 'close', '', '')}>
                        <CModalTitle>Customer Address</CModalTitle>
                    </CModalHeader>
                    <CModalBody>
                        <CForm className="row g-3" id="address-form" onSubmit={this.handleOnSubmit}>
                            <CCol md={6}>
                                <CFormFloating className="mb-3">
                                    <CFormControl
                                        ...
                                        required
                                    />
                                    <CFormLabel htmlFor="floatingFirstName">First name</CFormLabel>
                                </CFormFloating>
                            </CCol>
                            <CCol md={6}>
                                <CFormFloating>
                            ...
                            <CCol md={3}>
                                <CFormFloating>
                                    <CFormControl
                                        ...
                                        required
                                    />
                                    <CFormLabel htmlFor="floatingPostalCode">Postal code</CFormLabel>
                                </CFormFloating>
                            </CCol>
