...
export const getIncomingSupplies = (query, page, limit) => async (dispatch) => {
...
export const getIncomingSuppliesByPendingStatus = (query, page, limit) => async (dispatch) => {
    return IncomingSupplyApiService.getIncomingSuppliesByPendingStatus(
      query,
      page,
      limit,
    ).then(
