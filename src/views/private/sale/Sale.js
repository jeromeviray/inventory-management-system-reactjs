  ...
  manageResponse(prevProps, prevState) {
    if (this.props.orderResponse != prevProps.orderResponse) {
      ...
      if (
        ...
        orderResponse.action == "GET_PAYMENT_TRANSACTIONS"
      ) {
        this.setState({
        ...
        >
          <CTableHead color="dark">
            <CTableRow className="text-center">
              ...
              <CTableHeaderCell scope="col">Paid At</CTableHeaderCell>
            </CTableRow>
          </CTableHead>
              ...
              payments.map((order, index) => {
                ...
                return (
                  <CTableRow className="text-center" key={index}>
                    ...
                    <CTableDataCell>{paymentStatus}</CTableDataCell>
                    <CTableDataCell>{order.externalReference}</CTableDataCell>
                    <CTableDataCell>{order.paid_at}</CTableDataCell>
                  </CTableRow>
                )
              })
            ) : (
