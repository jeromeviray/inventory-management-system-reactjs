        ...
        return (
            <>
                ...
                <CButton
                    ...
                    onClick={() => this.props.setAddressModal(!visible, 'Add', '', <FaIcons.FaPlus size={20} className="me-2" />)}
                >
                    ...
                    {addresses.map((address, index) => {
                        ...
                        return (
                            <CCol key={index} md={12} className="mb-3">
                                <CCard className={checked ? "border-envelope shadow" : "border-envelope"}>
                                    <CCardBody className="p-3 ">
                                        <div className="d-flex align-items-center justify-content-start">
                                            <CFormCheck
                                                ...
                                                style={cursorStyle}
                                                value={address.id}
                                                defaultChecked={this.props.getValue !== undefined ? checked : false}
                                                onChange={this.handleOnChange}
                                            />

                                            <CCardTitle className="ps-4">{address.firstName + " " + address.lastName}</CCardTitle>
                                        </div>
